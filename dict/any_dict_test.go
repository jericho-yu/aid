...
func Test1(t *testing.T) {
	t.Run("test1 NewAnyDict", func(t *testing.T) {
		d := MakeAnyDict[string, int]().Set("分数", 18).Set("年龄", 100)
...
func Test26(t *testing.T) {
	t.Run("test26 RemoveByValue方法", func(t *testing.T) {
		d := MakeAnyDict[string, int]().Set("分数", 18).Set("年龄", 100).Set("税务", 0)
...
func Test27(t *testing.T) {
	t.Run("test27 RemoveEmpty", func(t *testing.T) {
		d := MakeAnyDict[string, string]().Set("分数", "18").Set("年龄", "100").Set("税务", "")
		d.RemoveEmpty()
